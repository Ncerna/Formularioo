$(".btn-register").click(function () {
    ...
    if ($("#txtId").val() == "0" && $("#txt__numEmpleado").val() != "" && $("#txt___rfc").val() != "" && $("#txt__nombres").val() != "" && $("#txt___genero").val() != "" &&
        ...
        $("#txt__percepcionesMensual").val() != "" && $("#txt__aguinaldoPrimera").val() != "" && $("#txt__aguinaldoSegunda").val() != "" && $("#txt__primaVacacional").val() != "" &&
        $("#txt__bonoIncentivo").val() != "" && $("#txt__percepcionesAnual").val() != "" && $("#txt__nss").val() != "" && $("#txt__curp").val() != "" && $("#txt__nombreCompleto").val() != "" &&
        $("#txt__clave").val() != "" && $("#txt__netoEmpleado").val() != "") {
